...
# https://github.com/baudcode/tf-semantic-segmentation/blob/master/tf_semantic_segmentation/models/satellite_unet.py
...
def build_satellite_unet(n_classes, inputs, activation_last, num_first_filters=32,
    ...
    conv10 = Conv2D(n_classes, (1, 1), activation=activation_last)(conv9)
