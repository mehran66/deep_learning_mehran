...
def build_vgg16_unet(n_classes, base_model, activation):

    """ Encoder """
    s1 = base_model.get_layer("block1_conv2").output         ## (512 x 512)
    s2 = base_model.get_layer("block2_conv2").output         ## (256 x 256)
    s3 = base_model.get_layer("block3_conv3").output         ## (128 x 128)
    s4 = base_model.get_layer("block4_conv3").output         ## (64 x 64)

    """ Bridge """
    b1 = base_model.get_layer("block5_conv3").output         ## (32 x 32)
