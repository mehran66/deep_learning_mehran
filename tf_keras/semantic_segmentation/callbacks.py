...
def callbacks(model_check_points, main_model_name, backbone_model_name, tboard_dir, plot_dir, epochs, lr, stage='train'):
    ...
    checkpoint_path = os.path.join(model_check_points, f'{main_model_name}_{str(backbone_model_name)}_{stage}_val_IoU_max.hdf5')
